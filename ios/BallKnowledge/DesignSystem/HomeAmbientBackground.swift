...
struct HomeAmbientBackground: View {
            ...
            GeometryReader { geo in
                ...
                ZStack {
                    ...
                    glowOrb(
                        ...
                        diameter: 300,
                        core: BKTheme.accent.opacity(0.20),
                        blur: 58
                    )
                    ...
                    glowOrb(
                        ...
                        diameter: 240,
                        core: Color(hex: "00AA55").opacity(0.14),
                        blur: 50
                    )
                    ...
                    glowOrb(
                        ...
                        core: BKTheme.accent.opacity(0.07 + 0.04 * CGFloat(sin(t * 0.45))),
                        blur: 42
                    )
                }
            }
    ...
    private func rotatingWash(time: TimeInterval, size: CGSize) -> some View {
        AngularGradient(
            stops: [
                .init(color: .clear, location: 0),
                .init(color: BKTheme.accent.opacity(0.05), location: 0.22),
                .init(color: .clear, location: 0.45),
                .init(color: Color(hex: "006633").opacity(0.04), location: 0.68),
