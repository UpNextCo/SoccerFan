...
const OVERRIDES: Array<[string, string, string]> = [
  ...
  ['Jorge Resurrección Merodio', 'Spain', 'Koke'],
  ['Raúl García Escudero', 'Spain', 'Raúl García'],
  ['Dante Costa Santos', 'Brazil', 'Dante'],
  ['Francisco Alarcón Suárez', 'Spain', 'Isco'],
  ['Alejandro Gómez Villaverde', 'Argentina', 'Papu Gómez'],
  ['David Jiménez Silva', 'Spain', 'David Silva'],
  ['Francisco Femenía Far', 'Spain', 'Kiko Femenía'],
  ['Moisés Gómez Bordonado', 'Spain', 'Moi Gómez'],
  ['Joaquín Sánchez Rodríguez', 'Spain', 'Joaquín'],
  ['Pablo Sarabia García', 'Spain', 'Pablo Sarabia'],
  ['Marcos Aoás Corrêa', 'Brazil', 'Marquinhos'],
  ['Jorge Frello Filho', 'Italy', 'Jorginho'],
  ['Rubén García Santos', 'Spain', 'Rubén García'],
  ['José Reina Páez', 'Spain', 'Pepe Reina'],
  ['David López Silva', 'Spain', 'David López'],
  ['José Morales Nogales', 'Spain', 'José Luis Morales'],
  ['Manuel Trigueros Muñoz', 'Spain', 'Manu Trigueros'],
  ['Diego López Rodríguez', 'Spain', 'Diego López'],
  ['Enrique García Martínez', 'Spain', 'Kike García'],
  ['José Sanmartín Mato', 'Spain', 'Joselu'],
  ['John Riise', 'Norway', 'John Arne Riise'],
];
